    ...
    <footer className="bg-[#f5f3ef] text-[#2c2c2c]">
      ...
      <div className="mx-auto max-w-300 px-8 py-16 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.6fr]">
          ...
          {/* Contact column */}
          <div className="flex flex-col gap-4">
            <h3 className="font-serif text-xl font-normal text-[#2c2c2c] tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>{tNav('contact')}</h3>
            <p className="text-sm leading-relaxed text-[#2c2c2c]/60">
              WhatsApp: <a href="https://wa.me/84944659659" className="underline hover:text-[#2c2c2c]">+84.944659659</a><br/>
              Instagram: <a href="https://www.instagram.com/snaphanoi.photo/" className="underline hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">snaphanoi.photo</a><br/>
              Pinterest: <a href="https://www.pinterest.com/Snaphanoi/" className="underline hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">Snaphanoi</a>
            </p>
            <Link
              href={`/${locale}/contact`}
      ...
      <div className="border-t border-[#2c2c2c]/10">
        <div className="mx-auto flex max-w-300 flex-wrap items-center justify-between gap-4 px-8 py-5 md:px-12 lg:px-16">
          ...
          <div className="flex items-center gap-4 text-[#2c2c2c]/40">
            <Link href="https://www.facebook.com/" aria-label="Facebook" className="transition-colors hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">
              <Facebook size={17} strokeWidth={1.8} />
            </Link>
            <Link href="https://www.instagram.com/snaphanoi.photo/" aria-label="Instagram" className="transition-colors hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">
              <Instagram size={17} strokeWidth={1.8} />
            </Link>
            <Link href="https://wa.me/84944659659" aria-label="WhatsApp" className="transition-colors hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">
            ...
            <Link href="https://www.pinterest.com/Snaphanoi/" aria-label="Pinterest" className="transition-colors hover:text-[#2c2c2c]" target="_blank" rel="noopener noreferrer">
